"""
Django settings for cotizador_darien project.
...
MIDDLEWARE_CLASSES = [
    ...
    'cotizador_darien.middleware.AutoLogout',
]

ROOT_URLCONF = 'cotizador_darien.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'cotizador_darien/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'cotizador_darien.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "cotizador_darien/static"),
)
