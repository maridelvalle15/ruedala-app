"""
Django settings for ruedala_app project.
...
MIDDLEWARE_CLASSES = [
    ...
    'ruedala_app.middleware.AutoLogout',
]

ROOT_URLCONF = 'ruedala_app.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'ruedala_app/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ruedala_app.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "ruedala_app/static"),
)
